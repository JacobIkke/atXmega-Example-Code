...
int main(void){
	...
	uint16_t cnt1;
		...
		TCC2.LCMPA = cnt0; // PC0 = PWM1 set duty cycles 0-255
		TCC2.LCMPB = cnt0; // PC1 = PWM2 set duty cycles 0-255
		TCC2.LCMPC = cnt0; // PC2 = PWM3 set duty cycles 0-255
		TCC2.LCMPD = cnt0; // PC3 = PWM4 set duty cycles 0-255

		TCC2.HCMPA = cnt0; // PC4 = PWM5 set duty cycles 0-255
		TCC2.HCMPB = cnt0; // PC5 = PWM6 set duty cycles 0-255
		TCC2.HCMPC = cnt0; // PC6 = PWM7 set duty cycles 0-255
		TCC2.HCMPD = cnt0; // PC7 = PWM8 set duty cycles 0-255

		//8 x 8-bit PWM signals
		TCD2.LCMPA = cnt0; // PD0 = PWM9  set duty cycles 0-255
		TCD2.LCMPB = cnt0; // PD1 = PWM10 set duty cycles 0-255
		TCD2.LCMPC = cnt0; // PD2 = PWM11 set duty cycles 0-255
		TCD2.LCMPD = cnt0; // PD3 = PWM12 set duty cycles 0-255	 

		TCD2.HCMPA = cnt0; // PD4 = PWM13 set duty cycles 0-255
		TCD2.HCMPB = cnt0; // PD5 = PWM14 set duty cycles 0-255
		TCD2.HCMPC = cnt0; // PD6 = PWM15 set duty cycles 0-255
		TCD2.HCMPD = cnt0; // PD7 = PWM16 set duty cycles 0-255

		//4 x 16-bit PWM signals
		TCE0.CCA = cnt1; //PE0 = PWM17 set duty cycles 0-65535
		TCE0.CCB = cnt1; //PE1 = PWM18 set duty cycles 0-65535
		TCE0.CCC = cnt1; //PE2 = PWM19 set duty cycles 0-65535
		TCE0.CCD = cnt1; //PE3 = PWM20 set duty cycles 0-65535
